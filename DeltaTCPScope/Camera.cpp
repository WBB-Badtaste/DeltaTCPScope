...
{
	eye[0] = target[0] + (eyeDistance + disOffset) * cos(eyeAlpha + alphaOffset) * cos(eyeBeta + betaOffset);
	eye[1] = target[1] + (eyeDistance + disOffset) * sin(eyeAlpha + alphaOffset);
	eye[2] = target[2] + (eyeDistance + disOffset) * cos(eyeAlpha + alphaOffset) * sin(eyeBeta + betaOffset);
